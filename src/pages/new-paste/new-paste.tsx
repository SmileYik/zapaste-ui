...
import { MdDivider, MdElevatedButton, MdElevation, MdFilledTextField, MdIcon, MdIconButton, MdOutlinedSelect, MdOutlinedTextField, MdPrimaryTab, MdSecondaryTab, MdSelectOption, MdSwitch, MdTabs } from "../../components/Material";
import styles from "./new-paste.module.css"
import { lock, lock_open_right } from "../../components/Icons";
                ...
                <div className={`${styles["metadatas"]}`}>
                    ...
                    <span className={`${styles["metadatas"]}`}>
                        <label className={`${styles["switch"]}`}>
                            <span>公开</span>
                            <span><MdSwitch name="private" selected icons></MdSwitch></span>
                        </label>

                        <label className={`${styles["switch"]}`}>
                            <span>只读</span>
                            <span><MdSwitch name="read_only" icons></MdSwitch></span>
                        </label>
                    </span>
                </div>
        ...
        <span className={`${styles["switch-text-field"]}`}>
            ...
            >
                <MdIconButton
                    ...
                    toggle
                    selected={enabled}
                    onChange={(e: any) => { setEnabled(e.target.selected); setValue(undefined) }}
                    disabled={false}
                    type="button"
                >
                    <MdIcon>{lock}</MdIcon>
